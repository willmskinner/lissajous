...
A browser port of the [`lissajous_keyboard.py`](https://github.com/willmskinner/lissajous/tree/master)
...
[main README](https://github.com/willmskinner/lissajous/tree/master)
for the full control reference and tuning-system descriptions.

This branch (`web-interface`) contains only the static site and is kept
separate from `master`, which holds the Python original.
